...
class AdmissionForm extends Form{
	...
	public function __construct() {
		...
		$this->add ( array (
				...
				'type' => 'Hidden',
				'options' => array (
						'label' => iconv('ISO-8859-1', 'UTF-8','Num�ro facture')
				),
				'attributes' => array (
						'id' => 'numero'
				)
		...
		$this->add(array(
				...
				'options' => array (
						'value_options' => array(
								1 => 'Normal',
								2 => iconv ( 'ISO-8859-1', 'UTF-8','Pr�sentation R�sultat') ,
						),
				),
				'attributes' => array(
		...
		*/
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv('ISO-8859-1', 'UTF-8','M�canismes')
				),
				'attributes' => array (
		...
		$this->add(array(
				...
				'type' => 'Textarea',
				'options' => array (
						'label' => iconv('ISO-8859-1', 'UTF-8','Conduite � tenir')
				),
				'attributes' => array(
